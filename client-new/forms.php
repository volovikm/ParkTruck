...
class Form extends Input
{
            ...
            <form id="auth_form">
                ...
                <div class="input_form_div">
                    ...
                    <div class="password_restore_link_div">
                        <a class="link" target="_blank" href="password_restore.php">Восстановить пароль</a>
                    </div>
                    ...
                    <div class="reg_redirect_link_div">
                        <div>
                            <a href="../account/reg.php">Зарегистрироваться</a>
                        </div>
                    </div>

                    <div class="support_links_div">
                        <div>
                            <a target="_blank" href="../client-new/support.php?section=license_agreement">Лицензионное соглашение</a>
                        </div>
                        <div>
                            <a target="_blank" href="../client-new/support.php?section=license_agreement">Соглашение о персональных данных</a>
                        </div>
                    </div>
            ...
            <form id="reg_form">
                ...
                <div class="input_form_div">
                    ...
                    <div class="auth_redirect_link_div">
                        <div>
                            <a href="../account/auth.php">Войти если уже есть аккаунт</a>
                        </div>
                    </div>
    ...
    //Форма превью парковки
    public function parkingPreviewForm($role)
    {
        $name_display='
            <span class="info_note_header_value">Парковка: </span> 
            <span id="name_display" class="info_note_value"></span> 
        ';
        ...
        //Изменение формы в зависимости от ролей
        if($role=="driver" || $role=="unauthorized")
        {
            $buttons=$buttons.'
            <button id="rent_parking_button" class="secondary_button" type="button">Забронировать</button>
            ';
        }
        if($role=="parking_owner" || $role=="admin")
        {
            $buttons=$buttons.'
            <button id="open_parking_card_button" class="secondary_button" type="button">Открыть</button>
            ';
        }
